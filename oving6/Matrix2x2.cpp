...
Matrix2x2 & Matrix2x2::operator*=(const Matrix2x2 & rhs)
{
	...
	Kan du implementere *= ved å gjenbruke kode du har skrive allereie?
		...
		Tilleggsspørsmål: Hvorfor returnereres *this?
	*/
...
std::ostream & operator<<(std::ostream & os, const Matrix2x2 & rhs)
{
	...
	Kvifor bør denne funksjonen ta const argument? (t.d. const Matrix2x2 &rhs)
		...
		- Og da er det lurt å gi tydelig beskjed om at vi ikke har noen intensjon om det. Tar inn referanse
		  for å slippe unødig kopiering.
	...
	Når bør vi, og når bør vi ikkje (evt kan ikkje) nytte const-argument?
		...
		- Kan ikke være const, prøver du å endre en const kompilerer ikke koden.
		-- Merk at ingen ting hindrer deg i å si `type a = (type)a_const og så endre a. 
